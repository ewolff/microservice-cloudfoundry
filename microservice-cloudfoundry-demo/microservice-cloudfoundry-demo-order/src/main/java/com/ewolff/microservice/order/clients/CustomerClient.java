...
public class CustomerClient {
	...
	@Autowired
	public CustomerClient(@Value("${customer.service.host:customer.local.pcfdev.io}") String customerServiceHost,
			@Value("${customer.service.port:80}") long customerServicePort) {
		super();
