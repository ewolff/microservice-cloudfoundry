...
public class CatalogClient {
	...
	@Autowired
	public CatalogClient(@Value("${catalog.service.host:catalog.local.pcfdev.io}") String catalogServiceHost,
			@Value("${catalog.service.port:80}") long catalogServicePort) {
		super();
